            ...
            <div className="flex flex-wrap gap-4">
              ...
              {project.github && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-8 py-4 border-2 border-cyber-green text-cyber-green font-bold rounded-lg hover:bg-cyber-green hover:text-black transition-all group"
                >
